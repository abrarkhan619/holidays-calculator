function storeInput() {
  ...
  window.location.assign("/annual-leave-calculator/questions/length-of-nhs-service.html");
  } else {
    window.location.assign("/annual-leave-calculator/questions/start-of-leave-entitlement.html");
  }
}
